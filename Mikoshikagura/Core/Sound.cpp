...
const TCHAR* c_soundFilename[] = {
	_T(SOUND_DIR"BGM/title.wav"),
	_T(SOUND_DIR"BGM/game.wav"),
	_T(SOUND_DIR"BGM/rest.wav"),
	//_T(SOUND_DIR"SE/ok.wav"),
	//_T(SOUND_DIR"SE/damage.wav"),
	//_T(SOUND_DIR"SE/element.wav"),
};
...
HRESULT InitSound( HWND hWnd )
{
	...
	for (int i = 0; i < SOUND_MAX; i++)
	{
		...
		//g_pSoundBuffer[i]->SetVolume(-1800);
	}
